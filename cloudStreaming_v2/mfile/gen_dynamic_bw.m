...
function dynamic_bw = gen_dynamic_bw(T, delta, hi_bw, lo_bw, total_time, exp_num, cn)
    ...
    print(f, '-dpng', '-painters', '-r100', ['../exp/' vidName '-exp-' num2str(exp_num) '-conn-' num2str(cn) '-bw.png']);
end